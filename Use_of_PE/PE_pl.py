...
if __name__ == '__main__':
    ...
    image_dir = "./images/room_small.jpg"
    ...
    train_dataloader = torch.utils.data.DataLoader(training_dataset, batch_size=64, shuffle=True, num_workers=8, pin_memory=True)
    val_dataloader = torch.utils.data.DataLoader(training_dataset, batch_size=64, num_workers=8, pin_memory=True)
